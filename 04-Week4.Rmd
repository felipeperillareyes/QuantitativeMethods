...
ggplot(CO2, aes(x = Sim_ShareAgric_norm, y = Pred_TurnOut_Unif)) +
  geom_point() +
  geom_smooth(method = "lm", formula = y ~ x, se = FALSE, color = "purple") +  # Adding the regression line
  geom_hline(yintercept = mean(CO2$Pred_TurnOut_Unif), linetype = "dashed", color = "green") +  # Horizontal line at the mean of y
  geom_vline(xintercept = mean_AgricAreaPercent, linetype = "dashed", color = "orange") +  # Vertical line at the mean of x
...
ggplot(CO2, aes(x = Sim_ShareAgric_norm, y = Pred_TurnOut_Lnorm)) +
  geom_point() +
  geom_smooth(method = "lm", formula = y ~ x, se = FALSE, color = "purple") +  # Adding the regression line
  geom_hline(yintercept = mean(CO2$Pred_TurnOut_Lnorm), linetype = "dashed", color = "green") +  # Horizontal line at the mean of y
  geom_vline(xintercept = mean_AgricAreaPercent, linetype = "dashed", color = "orange") +  # Vertical line at the mean of x
...
ggplot(CO2, aes(x = Sim_ShareAgric_norm, y = parab_norm_resid)) +
  geom_point() +
  geom_smooth(method = "lm", formula = y ~ x, se = FALSE, color = "green") +  # Adding the regression line
  theme_minimal() +
  labs(
    x = "Agricultural Area (%)",
    y = "Error",
...
ggplot(CO2, aes(x = Sim_ShareAgric_norm, y = Pred_TurnOut_parab_norm_resid)) +
  geom_point() +
  geom_smooth(method = "lm", formula = y ~ x, se = FALSE, color = "purple") +  # Adding the regression line
  geom_hline(yintercept = mean(CO2$Pred_TurnOut_parab_norm_resid), linetype = "dashed", color = "green") +  # Horizontal line at the mean of y
  geom_vline(xintercept = mean_AgricAreaPercent, linetype = "dashed", color = "orange") +  # Vertical line at the mean of x
  scale_y_continuous(limits = c(25, max(CO2$Pred_TurnOut_Unif, na.rm = TRUE))) +  #
  theme_minimal() +
  labs(
...
ggplot(CO2, aes(x = Sim_ShareAgric_norm, y = Pred_TurnOut_parab_norm_resid)) +
  geom_point() +
  geom_smooth(method = "lm", formula = y ~ x + I(x^2), se = FALSE, color = "purple") +  # Adding the regression line
  geom_hline(yintercept = mean(CO2$Pred_TurnOut_parab_norm_resid), linetype = "dashed", color = "green") +  # Horizontal line at the mean of y
  geom_vline(xintercept = mean_AgricAreaPercent, linetype = "dashed", color = "orange") +  # Vertical line at the mean of x
  scale_y_continuous(limits = c(25, max(CO2$Pred_TurnOut_Unif, na.rm = TRUE))) +  #
  theme_minimal() +
